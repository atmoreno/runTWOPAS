...
public class RunTwopas {
    ...
    public static void main60minutes(String[] args) throws IOException, InterruptedException {
    ...
    public static void main15minutes(String[] args) throws IOException, InterruptedException {
